...
public class Settings {
    ...
    int toggleModifier = MOD_ALT;
    int toggleKeyCode = 0x51; // VK_Q

    // Send-back hotkey - default ALT+W
    int sendBackModifier = MOD_ALT;
    int sendBackKeyCode = 0x57; // VK_W

    // Control panel toggle hotkey - default ALT+E
    int panelToggleModifier = MOD_ALT;
    int panelToggleKeyCode = 0x45; // VK_E
